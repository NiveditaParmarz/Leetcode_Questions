<h2> 452 70
2447. Number of Subarrays With GCD Equal to K</h2><hr><div><p>Given an integer array <code>nums</code> and an integer <code>k</code>, return <em>the number of <strong>subarrays</strong> of </em><code>nums</code><em> where the greatest common divisor of the subarray's elements is </em><code>k</code>.</p>
...
<pre><strong>Input:</strong> nums = [9,3,1,2,6,3], k = 3
...
<pre><strong>Input:</strong> nums = [4], k = 7
